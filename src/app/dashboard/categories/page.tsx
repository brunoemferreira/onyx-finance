...
const iconOptions = [
  ...
  { value: "droplet", label: "Água / Saneamento", icon: Droplet },
  { value: "zap", label: "Energia / Eletricidade", icon: Zap },
  { value: "droplets", label: "Líquidos / Água", icon: Droplets },
  { value: "cloud-rain", label: "Chuva / Tempo", icon: CloudRain },
  { value: "thermometer", label: "Temperatura", icon: Thermometer },
  { value: "leaf", label: "Natureza / Meio Ambiente", icon: Leaf },
  { value: "sprout", label: "Jardinagem / Plantas", icon: Sprout },
  { value: "building", label: "Prédio / Condomínio", icon: Building },
  { value: "building-2", label: "Empresa / Negócios", icon: Building2 },
  { value: "banknote", label: "Cédulas / Dinheiro", icon: Banknote },
  { value: "circle-dollar-sign", label: "Dólar / Moeda", icon: CircleDollarSign },
  { value: "landmark", label: "Banco / Instituição", icon: Landmark },
  { value: "vault", label: "Cofre / Segurança", icon: Vault },
  { value: "shopping-cart", label: "Carrinho de Compras", icon: ShoppingCart },
  { value: "shopping-basket", label: "Cesta de Compras", icon: ShoppingBasket },
  { value: "package", label: "Pacote / Encomenda", icon: Package },
  { value: "chef-hat", label: "Culinária / Restaurante", icon: ChefHat },
  { value: "pizza", label: "Pizza / Fast Food", icon: Pizza },
  { value: "croissant", label: "Padaria / Pães", icon: Croissant },
  { value: "egg", label: "Ovos / Mercado", icon: Egg },
  { value: "ice-cream", label: "Sorvete / Sobremesas", icon: IceCream },
  { value: "cup-soda", label: "Refrigerante / Bebidas", icon: CupSoda },
  { value: "glass-water", label: "Copo / Água", icon: GlassWater },
  { value: "martini", label: "Drinks / Coquetéis", icon: Martini },
  { value: "cake", label: "Bolo / Aniversário", icon: Cake },
  { value: "candy", label: "Doces / Bomboniere", icon: Candy },
  { value: "cookie", label: "Biscoitos / Lanches", icon: Cookie },
  { value: "soup", label: "Sopa / Refeições", icon: Soup },
  { value: "apple", label: "Maçã / Frutas", icon: Apple },
  { value: "beef", label: "Carnes / Açougue", icon: Beef },
  { value: "carrot", label: "Legumes / Hortifruti", icon: Carrot },
  { value: "nut", label: "Castanhas / Grãos", icon: Nut },
  { value: "milestone", label: "Marcos / Metas", icon: Milestone },
  { value: "navigation", label: "Navegação / GPS", icon: Navigation },
  { value: "map", label: "Mapa / Viagem", icon: Map },
  { value: "luggage", label: "Bagagem / Aeroporto", icon: Luggage },
  { value: "ship", label: "Navio / Cruzeiro", icon: Ship },
  { value: "puzzle", label: "Quebra-cabeças / Jogos", icon: Puzzle },
  { value: "dice-1", label: "Dados / Sorte", icon: Dice1 },
  { value: "ghost", label: "Fantasma / Terror", icon: Ghost },
  { value: "bomb", label: "Bomba / Urgência", icon: Bomb },
  { value: "palette", label: "Arte / Pintura", icon: Palette },
  { value: "paintbrush", label: "Pincel / Design", icon: Paintbrush },
  { value: "highlighter", label: "Marcador / Papelaria", icon: Highlighter },
  { value: "pen-tool", label: "Caneta / Escrita", icon: PenTool },
  { value: "microscope", label: "Pesquisa / Ciência", icon: Microscope },
  { value: "telescope", label: "Telescópio / Observação", icon: Telescope },
  { value: "atom", label: "Átomo / Química", icon: Atom },
  { value: "flask-conical", label: "Frasco / Laboratório", icon: FlaskConical },
  { value: "syringe", label: "Seringa / Vacinas", icon: Syringe },
  { value: "pill", label: "Comprimidos / Farmácia", icon: Pill },
  { value: "bandage", label: "Curativo / Primeiros Socorros", icon: Bandage },
  { value: "medal", label: "Medalha / Prêmios", icon: Medal },
  { value: "trophy", label: "Troféu / Competições", icon: Trophy },
  { value: "target", label: "Alvo / Objetivos", icon: Target },
  { value: "video", label: "Vídeo / Gravação", icon: Video },
  { value: "mic", label: "Microfone / Áudio", icon: Mic },
  { value: "headphones", label: "Fones / Música", icon: Headphones },
  { value: "radio", label: "Rádio / Sintonia", icon: Radio },
  { value: "monitor", label: "Monitor / PC", icon: Monitor },
  { value: "battery", label: "Bateria", icon: Battery },
  { value: "plug-zap", label: "Carregador", icon: PlugZap },
  { value: "washing-machine", label: "Máquina de Lavar", icon: WashingMachine },
  { value: "microwave", label: "Micro-ondas", icon: Microwave },
  { value: "heater", label: "Aquecedor", icon: Heater },
  { value: "bath", label: "Banho / Higiene", icon: Bath },
  { value: "shower-head", label: "Chuveiro", icon: ShowerHead },
  { value: "bed", label: "Cama / Móveis", icon: Bed },
  { value: "sofa", label: "Sofá / Decoração", icon: Sofa },
  { value: "archive", label: "Arquivo / Armazenamento", icon: Archive },
  { value: "box", label: "Caixa / Mudança", icon: Box },
  { value: "umbrella", label: "Guarda-chuva / Proteção", icon: Umbrella },
  { value: "bird", label: "Pássaro / Pet", icon: Bird },
  { value: "tent", label: "Barraca / Acampamento", icon: Tent },
  { value: "mountain", label: "Montanha / Trilha", icon: Mountain },
  { value: "waves", label: "Ondas / Praia", icon: Waves },
  { value: "sun", label: "Sol / Calor", icon: Sun },
  { value: "moon", label: "Lua / Noite", icon: Moon },
  { value: "star", label: "Estrela / Favoritos", icon: Star },
  { value: "shield-check", label: "Seguro Protegido", icon: ShieldCheck },
  { value: "bell", label: "Sino / Lembrete", icon: Bell },
  { value: "calendar-days", label: "Dias / Eventos", icon: CalendarDays },
  { value: "clipboard", label: "Prancheta / Tarefas", icon: Clipboard }
];
